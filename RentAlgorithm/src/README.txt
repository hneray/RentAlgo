...
check that sums to total rent
check that values are nonnegative
sanitize name input?


encapsulate main method


limit total rent > epsilon > 1


check comments

check parseInts for epsilon and rents are nums and not chars/strings